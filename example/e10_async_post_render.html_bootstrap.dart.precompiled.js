...
if($desc instanceof Array)$desc=$desc[1]
kY.prototype=$desc
function ZL(wI,mA,uj,yJ,kW,oI){this.wI=wI
this.mA=mA
this.uj=uj
this.yJ=yJ
this.kW=kW
this.oI=oI}ZL.builtin$cls="ZL"
if(!"name" in ZL)ZL.name="ZL"
$desc=$collectedClasses.ZL
if($desc instanceof Array)$desc=$desc[1]
ZL.prototype=$desc
