...
s="Task "+H.d(y)
s=P.EF(["title",s,"duration","5 days","percentComplete",C.CD.yu(C.jn.UD(C.pr.j1(100))),"start","01/01/2009","finish","01/05/2009","effortDriven",J.jO(y,5)===0],null,null)
...
$isiP:true,
static:{"^":"qa,v3,A2,yM,h2,zj,ra,Ya,FS,Gi,Fz,cR,E0,mj,tr,Nr,EE,o4I,Kz,J7,dM,fQ",Gl:function(a){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j
...
if($desc instanceof Array)$desc=$desc[1]
kT.prototype=$desc
function Kx(pH,Mu,IH){this.pH=pH
this.Mu=Mu
