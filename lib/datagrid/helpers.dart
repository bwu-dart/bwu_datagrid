...
class Column extends JsProxy {
  ...
  void extend(Column c) {
    ...
    if (c.cannotTriggerInsert != null) cannotTriggerInsert =
        c.cannotTriggerInsert;
    ...
    if (c.groupTotalsFormatter != null) groupTotalsFormatter =
        c.groupTotalsFormatter;
...
class GridOptions {
  ...
  void extend(GridOptions o) {
    ...
    if (o.asyncEditorLoadDelay != null) asyncEditorLoadDelay =
        o.asyncEditorLoadDelay;
    if (o.asyncEditorLoading != null) asyncEditorLoading = o.asyncEditorLoading;
    if (o.asyncPostRenderDelay != null) asyncPostRenderDelay =
        o.asyncPostRenderDelay;
    if (o.autoEdit != null) autoEdit = o.autoEdit;
    if (o.autoHeight != null) autoHeight = o.autoHeight;
    if (o.cellFlashingCssClass != null) cellFlashingCssClass =
        o.cellFlashingCssClass;
    if (o.cellHighlightCssClass != null) cellHighlightCssClass =
        o.cellHighlightCssClass;
    if (o.dataItemColumnValueExtractor != null) dataItemColumnValueExtractor =
        o.dataItemColumnValueExtractor;
    ...
    if (o.enableAsyncPostRender != null) enableAsyncPostRender =
        o.enableAsyncPostRender;
    if (o.enableCellNavigation != null) enableCellNavigation =
        o.enableCellNavigation;
    if (o.enableColumnReorder != null) enableColumnReorder =
        o.enableColumnReorder;
    if (o.enableTextSelectionOnCells != null) enableTextSelectionOnCells =
        o.enableTextSelectionOnCells;
    if (o.explicitInitialization != null) explicitInitialization =
        o.explicitInitialization;
    ...
    if (o.leaveSpaceForNewRows != null) leaveSpaceForNewRows =
        o.leaveSpaceForNewRows;
    ...
    if (o.selectedCellCssClass != null) selectedCellCssClass =
        o.selectedCellCssClass;
    if (o.showHeaderRow != null) showHeaderRow = o.showHeaderRow;
    if (o.showTopPanel != null) showTopPanel = o.showTopPanel;
    if (o.syncColumnCellResize != null) syncColumnCellResize =
        o.syncColumnCellResize;
