...
abstract class GroupTotalsFormatter extends fm.Formatter {
  void format(dom.Element target, GroupTotals totals, Column columnDef);
}

//abstract class GroupTitleFormatter extends fm.GroupTitleFormatter {
//  dom.Node format(Group totals);
//}
